...
const figmaLogo = new URL("./assets/figma.svg", import.meta.url);
const flowbiteReactLogo = new URL(
  "./assets/flowbite-react.svg",
  import.meta.url,
);
const flowbiteLogo = new URL("./assets/flowbite.svg", import.meta.url);
const patternDark = new URL("./assets/pattern-dark.svg", import.meta.url);
const patternLight = new URL("./assets/pattern-light.svg", import.meta.url);
...
export function App() {
  const CARDS = [
    ...
    },
    {
      ...
      icon: <img alt="Flowbite Pro logo" src={flowbiteLogo} />,
    },
    {
      ...
      icon: <img alt="Figma logo" src={figmaLogo} />,
    },
  ];
